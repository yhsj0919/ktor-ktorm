...
inline fun <E : Any, T : Table<E>> EntitySequence<E, T>.filterIf(
    condition: Boolean,
...
inline fun <E : Any, T : BaseTable<E>> EntitySequence<E, T>.filterOr(
    predicate: (T) -> ColumnDeclaring<Boolean>,
): EntitySequence<E, T> {
...
inline fun <E : Any, T : BaseTable<E>> EntitySequence<E, T>.filterIfOr(
    condition: Boolean,
    predicate: (T) -> ColumnDeclaring<Boolean>,
): EntitySequence<E, T> {
    return if (condition) {
